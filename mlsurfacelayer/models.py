...
def save_random_forest_csv(random_forest_model, features, out_path, forest_name="random_forest"):
    ...
    rf_frames = random_forest_dataframes(random_forest_model)
...
def random_forest_dataframes(random_forest_model):
    rf_frames = []
    for d, dt in enumerate(random_forest_model.estimators_):
        rf_frames.append(decision_tree_dataframe(dt))
    return rf_frames


def decision_tree_dataframe(decision_tree_model):
    """
