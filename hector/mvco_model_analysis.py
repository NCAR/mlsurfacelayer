...
if __name__ == "__main__":
    ...
    draw_loss(0, directory, show=args.show, save=args.save, save_file=directory)
    draw_loss(20, str(directory+'20'), show=args.show, save=args.save, save_file=directory)
    draw_mf(pred, directory, show=args.show, save=args.save, save_file=directory)
    draw_hf(pred, directory, show=args.show, save=args.save, save_file=directory)
    draw_group_time_series(pred, ex_pred1, pred1, show=args.show, save=args.save, save_file=directory)
    draw_group_time_series(pred, ex_pred2, pred2, show=args.show, save=args.save, save_file=directory)
...
#        if os.path.isdir(subdir_path) and subdir.startswith(args.exp_name):
...
#        directory = f'{main_folder}/model_QC__{idx + 1}'
#
#
#        #
...
#        
#        pred2 = 'heat_flux'
#        e_pred2 = 'heat_flux:18.4_m:degrees_C_m_s-1' # degrees celsius , meters per second
#        
#        mo_version = '-mo_branko'
#        mo_version2 = '-mo_alternate'
#        # model options above ---------------------------------------------------
...
#        #model_metrics
#
#        draw_loss(0, directory, show=args.show, save=args.save, save_file=args.save_file)
#        draw_loss(20, directory, show=args.show, save=args.save, save_file=args.save_file)
#        draw_mf(pred, show=args.show, save=args.save, save_file=args.save_file)
#        draw_hf(pred, show=args.show, save=args.save, save_file=args.save_file)
#        draw_group_time_series(pred, ex_pred1, pred1, show=args.show, save=args.save, save_file=args.save_file)
#        draw_group_time_series(pred, ex_pred2, pred2, show=args.show, save=args.save, save_file=args.save_file)
